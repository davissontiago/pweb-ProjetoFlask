...
class ClassDAO: 
    ...
    sqlSelect = 'SELECT t.id, t.semestre, c.nome_curso, p.nome, p.disciplina FROM turma AS t JOIN professor AS p ON t.professor_id = p.id JOIN curso AS c ON t.curso_id = c.id ORDER BY id ASC'
